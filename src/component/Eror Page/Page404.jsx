...
function Page404() {
    ...
    useEffect(() => {
        ...
        const intervalId = setInterval(() => {
            if (document.querySelector('.message p').className == "TextBlue") {
                document.querySelector('.message p').className = "TextRed";
            }
            else {
                document.querySelector('.message p').className = "TextBlue";
            }
    ...
    return (
        ...
        <div className='Page404'>
            ...
            <div id='BackGroundErorPage'>

                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 200 82.7">
